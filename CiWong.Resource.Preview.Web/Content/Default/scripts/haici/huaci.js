...
var huaci_com_url = "/Content/Default/Scripts/haici/huaci_com.js"; //com js路径
var ICIBA_HUAYI_Str = '';
var ICIBA_HUAYI_ALLOW = 1;
ICIBA_HUAYI_Str += '<link type="text/css" rel="stylesheet" href="'+iciba_huaci_url+'mini.css" />';
ICIBA_HUAYI_Str += '<div id="icIBahyI-yi" style="display:none;z-index:2200"></div>';
...
ICIBA_HUAYI_Str += '<div id="ICIBA_TOO_LONG" style="height:150px" class="icIBahyI-footer">您划取的内容太长，建议您去百度<a href="http://fanyi.baidu.com">翻译</a>页面。</div>';
...
ICIBA_HUAYI_Str += ' <script src="' + huaci_com_url + '" charset="utf-8" ></script>';
