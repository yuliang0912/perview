...
function() 
{
    ...
    if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) 
    {
        ...
        _19 = "<embed type=\"application/x-shockwave-flash\" src=\"" + this.getAttribute("swf") + "\" width=\"" + this.getAttribute("width") + "\" height=\"" + this.getAttribute("height") + "\" style=\"" + this.getAttribute("style") + "\""; _19 += " wmode=\"transparent\" id=\"" + this.getAttribute("id") + "\" name=\"" + this.getAttribute("id") + "\" ";
...
function loadFlash(flashURL, widthSize, heightSize, imgID, imgID2) {
        document.getElementById(imgID).style.display = "none";
        document.getElementById(imgID2).style.display = "block";
        var so = new SWFObject(flashURL, "flashmovie", widthSize, heightSize, "7");
        so.write("swfDIV_" + imgID);
}
function closeFlash(imgID, imgID2) {
        document.getElementById(imgID).style.display = "block";
        document.getElementById(imgID2).style.display = "none";
        document.getElementById("swfDIV_" + imgID).innerHTML = null;
}
